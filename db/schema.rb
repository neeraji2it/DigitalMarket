...
ActiveRecord::Schema.define(version: 20150402092729) do
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "tech_mobile"
    t.string   "tech_telephone"
    t.string   "contact_fax"
    t.string   "contact_email"
    t.string   "infra_dialer_name"
    t.string   "infra_predictive"
    t.string   "infra_seat"
    t.string   "infra_primary_isp"
    t.string   "infra_secondary_isp"
    t.string   "infra_voip_gateway"
    t.string   "infra_countries_dialing"
    t.string   "infra_server_ip"
    t.string   "reset_password_token"
    t.datetime "reset_password_sent_at"
    t.datetime "remember_created_at"
    t.integer  "sign_in_count",           default: 0,  null: false
